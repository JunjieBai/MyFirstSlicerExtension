...
class lineIntensityProfileWidget(ScriptedLoadableModuleWidget):
  ...
  def setup(self):
    ...
    self.inputRuler.setToolTip( "Select the ruler to pick line intensity profile." )
...
class lineIntensityProfileLogic(ScriptedLoadableModuleLogic):
  ...
  def probeVolume(self, volumeNode, rulerNode):
    ...
    print('p0 RAS coordinate: ', str(p0ras))
    ...
    print('p0 ITK coordinate: ', str(p0ijk))
    sys.stdout.flush()
